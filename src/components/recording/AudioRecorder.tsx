...
export default function AudioRecorder({
  ...
  const promptTypographyClass = sniperMode
    ? "text-left [&_h1]:mb-2 [&_h1]:text-xl [&_h1]:font-medium [&_h1]:text-foreground [&_h2]:mb-2 [&_h2]:text-xl [&_h2]:font-medium [&_h2]:text-foreground [&_h3]:mb-2 [&_h3]:text-xl [&_h3]:font-medium [&_h3]:text-foreground [&_h4]:mb-2 [&_h4]:text-xl [&_h4]:font-medium [&_h4]:text-foreground [&_h5]:mb-2 [&_h5]:text-xl [&_h5]:font-medium [&_h5]:text-foreground [&_h6]:mb-2 [&_h6]:text-xl [&_h6]:font-medium [&_h6]:text-foreground [&_p]:mb-3 [&_p]:text-xl [&_p]:font-medium [&_p]:leading-snug [&_p]:text-muted-foreground [&_ol]:list-decimal [&_ol]:list-outside [&_ol]:space-y-1 [&_ol]:pl-5 [&_ol]:text-xl [&_ol]:font-medium [&_ol]:leading-snug [&_ol]:text-muted-foreground [&_ul]:list-disc [&_ul]:list-outside [&_ul]:space-y-1 [&_ul]:pl-5 [&_ul]:text-xl [&_ul]:font-medium [&_ul]:leading-snug [&_ul]:text-muted-foreground [&_li]:leading-snug [&_li]:font-medium [&_a]:underline"
