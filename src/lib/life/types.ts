...
export const LIFE_BETS: ReadonlyArray<{
  ...
  // Founder 2026-07-27 — the LABEL is "The Career"; the KEY stays `company`.
  // "The", like its two neighbours: these are three named bets, not three
  // categories, and the article is what makes them read as a set.
  ...
  { key: "company", rank: 2, glyph: "🔵", label: "The Career", color: "#1971c2" },
