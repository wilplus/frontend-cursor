        ...
        <article className="space-y-6 text-sm leading-relaxed text-foreground">
          ...
          <section className="space-y-2">
            <div className="rounded-md border border-border bg-muted/40 p-4 text-muted-foreground">
              <p>
                ...
                WillpowerLab&apos;s shared models. Recording and coaching
                require that consent. We also explain how to withdraw it and
                what happens next (§3, §5, §10 and §11).
              </p>
            </div>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              <em>działalność nieewidencjonowana</em>) below the revenue
              threshold that requires business registration under Polish law.
              For the purposes of the EU General Data Protection Regulation
              (Regulation (EU) 2016/679, &quot;GDPR&quot;) and the Polish Act of
              10 May 2018 on the Protection of Personal Data, the Data
              Controller is:
            </p>
            <div className="rounded-md border border-border bg-muted/40 p-4 text-muted-foreground">
              <p>
              ...
              <p>
                ...
                (a postal contact address is available on request to data
                subjects and to the supervisory authority)
              </p>
            </div>
            <p className="text-muted-foreground">
              Given the small scale of processing, we are{" "}
              <strong>
                not required to, and have not, appointed a Data Protection
                Officer
              </strong>{" "}
              (GDPR Art. 37). The operator handles all privacy requests directly
              at the email above.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              <li>
                ...
                identifiers including your IP address, device/browser
                information, and authentication metadata.
              </li>
              <li>
                <strong>Voice Data:</strong> audio recordings of your voice that
                you create when you record a &quot;take&quot; or re-read within
                the Service.
              </li>
              <li>
              ...
              <li>
                <strong>Ratings and Labels:</strong> where you rate an extract
                as part of peer review (§7), the judgements you give; and where
                a coach reviews your content (§8), the corrections and labels
                they record.
              </li>
              <li>
                <strong>Usage Data:</strong> logs of how you interact with the
                Service (features used, sessions, timestamps, error and
                diagnostic data) used to operate, secure, and improve the
                Service.
              </li>
              <li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              ...
              <li>
                <strong>Explicit consent (Article 6(1)(a)).</strong> We record
                your voice, generate personalized coaching, and use eligible
                practice data to evaluate, train and improve WillpowerLab&apos;s
                shared models{" "}
                <strong>
                  only after you have given clear, affirmative consent
                </strong>
                . These two connected purposes are accepted together and are
                required to use recording and coaching. Consent is also the
                basis for the inference described in §6. You may withdraw at any
                time (see §11); withdrawal ends recording and coaching access
                and does not affect processing lawfully carried out before
                withdrawal.
              </li>
              <li>
                <strong>Legitimate interests (Article 6(1)(f)).</strong> We
                process Usage Data to secure the Service, prevent abuse, and
                improve reliability where those interests are not overridden by
                your rights and freedoms. We do not use legitimate interests as
                the basis for pooled model training. You may object to
                legitimate- interests processing (see §11).
              </li>
              <li>
                <strong>Legal obligation (Article 6(1)(c)).</strong> We process
                limited billing data to meet applicable Polish accounting and
                tax obligations.
              </li>
            </ul>
            <p className="text-muted-foreground">
              <strong>
                Special categories of data (Article 9): important
                characterisation.
              </strong>{" "}
              WillpowerLab processes your voice{" "}
              <strong>
                to analyse speech delivery (pace, fillers, structure, clarity),
                not to uniquely identify you.
              </strong>{" "}
              ...
              ordinary personal data and the special-category regime of Article
              9 is, in our assessment,{" "}
              <strong>not triggered by the processing itself</strong>. However,
              because voice can be sensitive and because the measurements
              described in §6 could touch on inferences a user might regard as
              sensitive (for example, indicators of stress or emotional state),
              we adopt a cautious posture:{" "}
              <strong>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              feedback systems that power WillpowerLab. An earlier version of
              this Policy said only that we do not train public AI foundation
              models. That was true, but incomplete. This section states the
              position accurately.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              <li>
              ...
              <li>
                <strong>We do not</strong> provide your content to third parties
                to train their own general-purpose or foundation models. Your
                Voice Data and transcripts are sent to OpenAI&apos;s developer
                API for analysis under its commercial API terms, under which{" "}
                <strong>
                ...
                them. We have disabled every optional data-sharing setting on
                our OpenAI account.
              </li>
              <li>
                <strong>We do not</strong> publish your recordings or
                transcripts.
              </li>
              <li>
                Aggregate, de-identified measurements may be used for research
                and for reporting about the Service in general terms.
              </li>
              <li>
                <strong>Deleting your account removes your content.</strong>{" "}
                Where a measurement or label derived from your content has
                already been incorporated into an aggregate model, that model is
                not retrained solely on that basis. We state this plainly so
                that it is not a surprise.
              </li>
            </ul>
            <p className="text-muted-foreground">
              <strong>
                You may withdraw this consent at any time (Art. 7(3)).
              </strong>{" "}
              Use Data &amp; consent in the account menu or contact us. We stop
              including your data in new training and start the applicable
              retention and purge process. Because the bundled consent is
              required for both connected purposes, withdrawal ends access to
              recording and coaching. See §11 for your other rights.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              The Service infers characteristics of{" "}
              <strong>speech delivery</strong> from your recordings. This
              inference runs as part of the Service.{" "}
              <strong>
            ...
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              ...
              <li>
                <strong>Verbal measurements</strong> — speech rate, filler
                words, and the structure of what you said.
              </li>
              <li>
            ...
            <p className="text-muted-foreground">
              <strong>
                ...
                scores, ratings, percentages, or verdicts, and they are not used
                to rank you against other users.
              </strong>{" "}
              What you see is a qualitative read: which version of a passage
              worked best, and coaching notes about it.
            </p>
            <p className="text-muted-foreground">
              We do <strong>not</strong> infer, and do not attempt to infer,
              your health, personality, ethnicity, or any comparable
              characteristic about you as a person. The measurements describe a
              recording, not a person, and are used for coaching only. See Terms
              of Service §7 for the prohibition on using the Service to assess
              employees, candidates, or students.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              <strong>opt-in, per recording, and revocable at any time.</strong>{" "}
              If you do not opt in, no other user will ever hear your voice.
              Extracts are presented to raters without your name — but{" "}
              <strong>
              ...
              disentangled from the calibration they have already contributed
              to.
            </p>
            <p className="text-muted-foreground">
              ...
              reliability. Raters are bound by the confidentiality obligations
              in Terms of Service §5.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              A{" "}
              <strong>
                human coach may listen to your recordings and read your
                transcripts
              </strong>{" "}
              in order to review, correct, or improve the feedback the Service
              gives you. Their corrections and labels are retained and used to
              calibrate our models, as described in §5.
            </p>
            <p className="text-muted-foreground">
              Coaches are bound by confidentiality obligations, and where a
              coach is not the operator they act under a written data-processing
              agreement. Human review happens only with your consent, and you
              can withdraw that consent at any time (see §11); feedback quality
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              (&quot;sub-processors&quot;) who process personal data on our
              behalf under written{" "}
              <strong>Data Processing Agreements (DPAs)</strong>. Where a
              sub-processor transfers data outside the European Economic Area
              (EEA), the transfer is governed by appropriate safeguards,
              ...
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="text-muted-foreground">
                  ...
                  <tr className="border-b border-border/50 align-top">
                    ...
                    <td className="py-2">
                      United States; DPA and SCCs; API inputs and outputs
                      retained up to 30 days for abuse monitoring, then deleted
                    </td>
                  </tr>
                  <tr className="border-b border-border/50 align-top">
                    <td className="py-2 pr-4">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              <li>
                <strong>Voice Data (audio files):</strong> retained for as long
                as needed to transcribe and analyse the take, to let you play it
                back, and — while the required consent remains active — for the
                model improvement described in §5. Withdrawal starts the
                applicable retention and purge process; deletion requests remain
                available.
              </li>
              <li>
                <strong>Shared extracts:</strong> retained while sharing is
                active, and removed from circulation when you withdraw sharing.
              </li>
              <li>
                <strong>
                  Text Data (transcripts, coaching notes, Ideal Text):
                </strong>{" "}
                retained for as long as your account remains active, so that
                your coaching history and Ideal Text remain available to you.
                Deleted upon account deletion or valid erasure request, subject
                to any overriding legal retention obligation.
              </li>
              <li>
                <strong>Derived measurements, ratings, and labels:</strong>{" "}
                retained while your account is active. Once incorporated into an
                aggregate model, the model itself is not retrained solely
                because one contribution was later deleted (§5).
              </li>
              <li>
              ...
              <li>
                <strong>Payment/billing records:</strong> retained for the
                period required by applicable Polish accounting and tax law.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1.5 pl-5 text-muted-foreground">
              <li>
                ...
                process your data and a copy of it (Art. 15).
              </li>
              <li>
              ...
              <li>
                ...
                in certain circumstances (Art. 18).
              </li>
              <li>
                <strong>Data portability:</strong> receive your data in a
                structured, commonly used, machine-readable format and transmit
                it to another controller (Art. 20).
              </li>
              <li>
                <strong>Object:</strong> object at any time to processing based
                on our legitimate interests, including security and reliability
                processing (Art. 21). Pooled model improvement relies on
                consent, not legitimate interests.
              </li>
              <li>
                <strong>Withdraw consent:</strong> withdraw any consent at any
                time, without affecting the lawfulness of prior processing (Art.
                7(3)). This includes the bundled personalized-coaching and
                shared- model consent (§5–§6), sharing your extracts (§7), and
                human coach review (§8). Withdrawing the bundled consent ends
                recording and coaching access.
              </li>
              <li>
                <strong>Not be subject to solely automated decisions</strong>{" "}
                producing legal or similarly significant effects (Art. 22). Our
                AI analysis is advisory coaching and does not produce such
                effects; a human remains responsible for any consequential
                decisions.
              </li>
            </ul>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              protect your data, including encryption in transit, row-level
              access controls on our database, hosting within the EU region for
              our primary datastore, and the limited-retention API arrangement
              with our AI processor described above. No system is perfectly
              secure, but we work to protect your data commensurate with its
              sensitivity.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              The Service is not directed to, and may not be used by, persons
              under the age of 18. We do not knowingly process the personal data
              of children. If we learn that we have collected such data, we will
              delete it.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              updated version with a new effective date and, for material
              changes, provide additional notice (e.g., by email or in-app).
