...
/**
 * POST /api/v2/internal/journal/reorder
 *
 * BFF passthrough for the Journal CMS (assign sort_order from an ordered id list).
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    upstream = await fetch(`${backend}/v2/internal/journal/reorder`, {
      method: "POST",
    ...
    console.error("POST /api/v2/internal/journal/reorder — fetch failed:", err);
    return NextResponse.json(
