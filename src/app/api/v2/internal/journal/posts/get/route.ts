...
/**
 * POST /api/v2/internal/journal/posts/get
 *
 * BFF passthrough for the Journal CMS (one post for editing).
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    upstream = await fetch(`${backend}/v2/internal/journal/posts/get`, {
      method: "POST",
    ...
    console.error("POST /api/v2/internal/journal/posts/get — fetch failed:", err);
    return NextResponse.json(
