...
/**
 * POST /api/v2/internal/journal/posts/delete
 *
 * BFF passthrough for the Journal CMS (delete one post).
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    upstream = await fetch(`${backend}/v2/internal/journal/posts/delete`, {
      method: "POST",
    ...
    console.error("POST /api/v2/internal/journal/posts/delete — fetch failed:", err);
    return NextResponse.json(
