...
/**
 * POST /api/v2/internal/journal/posts/create
 *
 * BFF passthrough for the Journal CMS (create a draft; returns the created post).
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    upstream = await fetch(`${backend}/v2/internal/journal/posts/create`, {
      method: "POST",
    ...
    console.error("POST /api/v2/internal/journal/posts/create — fetch failed:", err);
    return NextResponse.json(
